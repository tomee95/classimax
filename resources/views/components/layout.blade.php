...
<head>
    ...
    <!-- ** Basic Page Needs ** -->
    <meta charset="utf-8">
    <title>Classimax | Buy & Sell Near You</title>
                ...
                <nav class="navbar navbar-expand-lg navbar-light navigation">
                    ...
                    <div class="collapse navbar-collapse" id="navbarSupportedContent">
                        ...
                        <ul class="navbar-nav ml-auto mt-10">
                            @auth
                                <li class="nav-item pad-7">
                                    <span title="{{ auth()->user()->email }}">Hi <b>{{ Str::limit(auth()->user()->email, 15) }}</b>!</span>
                                </li>
                                <li class="nav-item">
                                ...
                                <li class="nav-item">
                                    <a class="nav-link text-white add-button" href="{{ url('/add-listing') }}"><i class="fa fa-plus-circle"></i> Post new Ad</a>
                                </li>
                            @else
                                <li class="nav-item">
                                ...
                                <li class="nav-item">
                                    <a class="nav-link text-white add-button" href="{{ url('/register') }}"><i class="fa fa-arrow-circle-right"></i> Register</a>
                                </li>
                            @endauth
                        </ul>
                    </div>
        ...
        <div class="row">
            ...
            <div class="col-lg-2 offset-lg-1 col-md-3 col-6 mb-4 mb-lg-0">
                <div class="block">
                    <h4>Site Pages</h4>
                    <ul>
                        <li><a href="{{ url('/dashboard') }}">My Ads</a></li>
                        <li><a href="{{ url('/dashboard') }}">Favourite Ads</a></li>
                        <li><a href="{{ url('/dashboard') }}">Archived Ads</a></li>
                        <li><a href="{{ url('/dashboard') }}">Pending Ads</a></li>
                        <li><a href="{{ url('/dashboard') }}">Terms & Conditions</a></li>
                    </ul>
                </div>
            </div>
            <!-- Link list -->
